...
class AnimRef(QDialog):
    ...
    def init(self):
        loader = QUiLoader()
        ui_file_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), "interface", 'interface.ui')
    ...
    def defineIcons(self):
        self.play_icon = QtGui.QIcon(os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\play.png"))
        self.n_frame_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\n_frame.png"))
        self.p_frame_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\p_frame.png"))
        self.s_frame_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\s_frame.png"))
        self.e_frame_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\e_frame.png"))
        self.load_images_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\load_images.png"))
        self.loop_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\loop.png"))
        self.pause_icon = QtGui.QIcon(
            os.path.join(os.path.dirname(os.path.realpath(__file__)) + "\\icons\\pause.png"))
